...
1.  Open a new browser tab in the lab VM. Right click the following link
    to copy and paste it in the browser window. [Market Trend Report -
    Protein
    Shake](https://edxinteractivepage.blob.core.windows.net/ms-4004/Market%20Trend%20Report-%20Protein%20shake.docx)
...
8.  Otherwise, open the file in **Word**, select the **Share** button
