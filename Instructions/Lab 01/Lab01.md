...
2.  On the navigation pane, select **+** icon and select **Files upload** to open it.
...
4.	Open and close the file **Fabrikam 2023 Income Statement** document (which you uploaded to OneDrive) 
    ...
    **Note**: When you open **Fabrikam 2023 Income Statement** document, you will see a pop-up as shown in 
...
8. In the **Pick a file** window that appears, under the **Recent** file list, select the **Fabrikam 2023 
   Income Statement.docx** file and then select the **Attach** button.
   ![](./media/image10.png)
