...
This lab introduces how Microsoft 365 Copilot Chat can support event
planning activities for Contoso Client Innovation Summit. As an event
planning consultant, you will use Copilot Chat in web mode to research
market trends, brainstorm session ideas, build an agenda, create
visuals, and develop a planning brief. The lab demonstrates how
...
2.  **Copilot Chat** page will open.
    ...
    ![A screenshot of a chat AI-generated content may be incorrect.](./media/image1.png)
...
3.  If, for some reason, “**Something went wrong”** message appears,
    ...
    features along with UI changes as part of Microsoft Build-2025 event).
...
5.  You will see the Copilot output with a short, insightful summary of
    ...
    You have now completed researching the 2025 market trends. Next you
    will turn these trends into a compelling event agenda that resonates
    with both the C-suite and client innovation teams.
...
4.  Copilot will start generating the logo with Microsoft Designer.
    ...
    Next you will compile a planning brief combining the outcomes from all
...
2.  You can now download by clicking on the file and view the compiled
    output.
...
4.  Once the updated planning brief is generated, you can download and
    ...
    ![A white text with black text AI-generated content may be
    incorrect.](./media/image23.png)

5.  You now have the professional planning document ready for review.
...
3.  Navigate to Apps and open **OneDrive** from the Microsoft 365
    Copilot navigation pane.
...
By completing this lab, you experienced how Microsoft 365 Copilot Chat
can transform event planning into a more efficient, collaborative, and
insightful process. You explored market trends, designed session
content, built a branded agenda, and refined a professional planning
brief with AI-driven recommendations. This hands-on practice highlights
the value of Copilot in delivering high-quality, well-structured
outcomes that align with strategic business goals.
