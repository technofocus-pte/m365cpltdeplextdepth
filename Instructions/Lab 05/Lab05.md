...
1.  Open a new browser tab in the lab VM. Right click the following link
    to copy and paste it in the browser window. [Fabrikam Q1 marketing
    campaigns](https://edxinteractivepage.blob.core.windows.net/ms-4004/Fabrikam%20Q1%20marketing%20campaigns.xlsx)

2.  Select “Download” to download the file to the VM.

> <span class="mark">Warning: Please do not use **Save a copy to One
...
8.  In **Excel**, on the **File** page, select **Fabrikam Q1 marketing
...
12. In looking at **Sheet 2**, you notice that Copilot didn't create a
...
13. Select **Sheet 1**, and then enter the following prompt:
...
15. Review the chart that Copilot created showing the revenue by
...
18. You now want to identify which campaigns were the most effective. To
...
32. Repeat the previous step a few times to have Copilot suggest
    different calculations. Insert the ones you like and skip the ones
    you don't.

33. You now want Copilot to show you some more charts that visualize
