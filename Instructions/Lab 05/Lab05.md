...
In this lab, you will use Microsoft 365 Copilot within **Microsoft 365
Apps** to

- Generate and edit content.

- Refine and enhance generated content using **Microsoft 365 Copilot
  Pages** features.

- Share and collaborate on **Microsoft 365 Copilot Pages** with a team
...
- **Content Structuring with "/" Menu**: Use the **"/" menu** to add
  ...
  structure the document effectively.
    ...
    **Note**: You will be using **Trey Research - VPN Technical
    Overview** document as a reference document shared by Trey Research.
...
3.  Click on the **Create or upload** button from the right side and
    then select **Files upload** option.

    ![](./media/image2.png)

4.  Browse to the **C:\LabFiles\MS4019** folder to select and upload a
    copy of **Trey Research - VPN Technical Overview** document
    to **OneDrive**.
...
5.  Now you will attach the reference document shared by Trey Research
    to start drafting the content for Executive summary. Select
    the **Attach** (+) icon to reference the document and then select
    **Attach cloud files**.

    ![](./media/image7.png)

6.  Select the document **Trey Research – VPN Technical Overview** and
...
2.  Paste this link in a **Teams channel** or **Outlook** email,
    ...
    **Note**: This lab environment is deployed with restricted
    ...
    collaborative way which you will otherwise do
...
1.  Now edit the page directly. Click on the text box you will now enter
...
3.  Copilot will generate and display the chart with the code
    snippet. Click on the **Edit In page** and the select **Add to
    page** option
...
6.  Click on the **Edit In page** and the select **Add to page** option

    ![A screenshot of a computer AI-generated content may be
    incorrect.](./media/image29.png)

7.  You will ensure all edits are complete and save the page with an
