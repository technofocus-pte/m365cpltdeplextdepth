...
1.  Open a Microsoft Edge browser and enter the following URL:
    ...
    **Note**: You need to sign-in (if prompted) using the Credentials
    provided under the Resources tab on the right.
...
2.  In the **Apps** page, scroll down to locate **Loop** and then select
    ...
    **Note**: If you don't see **Loop** listed in the Apps page,
    select **All apps**.
...
4.  In **Microsoft Loop**, the **Workspaces** tab is displayed by
    default. Create a new workspace for this project, select **+** on
    the top left next to **Getting started**, and then select **+New
    workspace** button.
...
6.  You're now on the first page for your new workspace. The name of the
    ...
    page to ++**Market research++**. Note how the page name is
    automatically updated in the navigation pane.
...
8.  In the prompt field, enter the following prompt and select
    ...
    **Note:** If you receive an error saying that something went wrong,
    copy and paste in the prior prompt and submit it again.

9.  Review the generated report. Rather than having all the information
...
10. Note how Copilot changed the formatting of the report. You now want
...
11. Click on the **Copy** button to copy the content and paste it in the
    empty draft.
...
12. Scroll to the bottom of the report and review Copilot's
    recommendation.
...
product, Contoso Protein Plus shake. The presentation should analyse the
...
2.  Select **Apps** in the navigation pane. Click **OneDrive** to open
    it.

    ![A screenshot of a computer AI-generated content may be
    incorrect.](./media/image15.png)

3.  Click on the **Create or upload** button and select **File upload**.

    ![A screenshot of a computer AI-generated content may be
    incorrect.](./media/image16.png)

4.  Browse to the **C:\LabFiles\MS4019** folder to select and upload a
    copy of **Market Trend Report - Protein Shake** to **OneDrive**
...
5.  Open and close the file **Market Trend Report - Protein
...
6.  On the **Microsoft 365** navigation pane, select **PowerPoint**. In
    PowerPoint, Click on **Create new blank presentation**.
...
7.  Select the **Copilot** icon (in red highlight as shown in the
    screenshot). In the **Copilot** pane that appears, several
    predefined prompts are available for you to choose from. Select
    the **Create presentation from file** prompt. 

    ![A screenshot of a computer AI-generated content may be
    incorrect.](./media/image20.png)

    Above the prompt field at the bottom of the **Copilot** pane,
    a **Suggestions** window may appear that contains the three most
    recently used files. If the **Market Trend Report - Protein
    Shake.docx** file appears in the MRU list, then select it.

8.  Otherwise, you can attach the reference document using the Attach
    cloud files option as shown in the screenshot. 
    ...
    **Note**: You can also attach the reference document using the link to
    the document. To get the link open the file in **Word**, select
    the **Share** button above the ribbon, select the **Copy Link** option
    from the drop-down menu, and then in this prompt field in
    the **Copilot** pane in **PowerPoint**, paste in the link following
    the forward slash (**Create presentation from file /**). Select
    the **Send** icon.

9.  Click on the **Generate Slides** to create suggested slides.
...
12. The **Designer** pane offers samples of different designs for the
...
13. Select one of the design options to have PowerPoint replace the
    current slide with the new design. This feature isn't
    Copilot-related. It's available in PowerPoint when you have a
    Microsoft 365 subscription.

    ![A screen shot of a video AI-generated content may be
    incorrect.](./media/image28.png)

14. Now let's see what else Copilot can do. Select
    the **Copilot** button to open the **Copilot** pane.

15. In the **Copilot** pane, note the section that says **Need a
    creative spark**. Copilot provides pre-built prompts that you can
    use to perform several tasks on the presentation.

    ![](./media/image29.png)

16. Select a **suggested prompt**.

    ![](./media/image30.png)

17. You can review the result.

    ![](./media/image31.png)

18. Above the prompt field, Copilot displays questions related to the
    ...
    the Q&A portion of the presentation. Review the questions that you
    see, and select one of them to see what happens.

    ![](./media/image32.png)

19. When you select any of these questions, Copilot generates an answer
...
20. In doing so, you can select the **Copy** option and then paste this
    answer in the speaker notes for any slide in which this text would
    make an appropriate note. Try it now. Select a question, copy the
    answer, then go to an appropriate slide and in the speaker notes,
    enter **Ctrl+V** to paste in the note.

    ![A screenshot of a computer AI-generated content may be
    incorrect.](./media/image34.png)

21. You now want Copilot to create a slide at the end of the
    presentation for a Q&A session. Select the **+ icon** next to prompt
    box and then click on the **view prompts.** Then select **Add a
    slide** option.
...
23. Review the Q&A slide that Copilot created. Now try one final thing.
...
24. Review the notes added by copilot.
...
26. Review the questions. Questions automatically added into the Q&A
    slide notes.
...
2.  Click on the **Apps** navigate to **OneDrive**.

    ![A screenshot of a computer AI-generated content may be
    incorrect.](./media/image44.png)

3.  Click on **Create or upload**, select **Files** **upload**.

    ![A screenshot of a computer AI-generated content may be
    incorrect.](./media/image45.png)

4.  Browse to the **C:\LabFiles\MS4019** folder to select and upload a
    copy of the following documents to OneDrive.
...
5.  In **Microsoft 365**, open **Microsoft Word** and then click on the
...
6.  In the **Draft with Copilot** window that appears at the top of the
    ...
    the **Draft with Copilot** window, select the **Add content** button.
    In the drop-down menu that appears, if the **Contoso Supplier
    Agreement** appears in the list of files, select it. Otherwise,
    select **Browse files from cloud**, select the **Contoso Supplier
    Agreement** from the **Recent** file list.
...
7.  Select **Generate icon**. At this point, Copilot extracts the
    pertinent information from the three supplier agreements drafts a
...
9.  The file is automatically saved into your **OneDrive**, so you can
    close this tab in your Microsoft Edge browser.
